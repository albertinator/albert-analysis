#!/usr/bin/env python3
"""Generate an HTML chart of electricity usage at 110 Tudor St."""
...
for d in data:
    # Use period_end as the date label if available, else statement_date
...
<html>
<head>
<title>110 Tudor St - Electricity Usage (2009-2026)</title>
...
// Cost Chart - Stacked Supply vs Delivery
